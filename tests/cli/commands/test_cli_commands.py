...
from src.cli.commands.cli_export_products import run_export_products_command
from src.cli.commands.cli_order_items import (
    load_order_items,
    prepared_order_items,
)
from src.cli.commands.cli_order_execution import (
    run_parallel_order,
...
class CliCommandsTests(unittest.TestCase):
        ...
        with TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                with patch("src.cli.cli_shared.require_state_file"):
                    from src.cli.commands.cli_order_items import prepared_order_items
    ...
    def _run_single_profile_and_capture_items(
        ...
        with (
            ...
            patch("src.cli.commands.cli_order_execution.run_profile_order") as run_order,
        ):
