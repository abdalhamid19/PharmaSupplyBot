...
from src.tawreed.matching.tawreed_match_logs import (
...
from src.tawreed.matching.tawreed_match_only import match_only_summary_rows, append_match_only_summary
...
class TawreedMatchLogsTests(unittest.TestCase):
    def test_append_order_result_summary_writes_structured_status_row(self) -> None:
        ...
        with (
            patch("src.tawreed.matching.tawreed_match_logs.append_csv_artifact") as append_csv,
            patch("src.tawreed.matching.tawreed_match_logs.append_xlsx_artifact") as append_xlsx,
        ):
    ...
    def test_write_match_log_uses_unified_matching_trace_csv(self) -> None:
        ...
        with (
            patch("src.tawreed.matching.tawreed_match_logs.write_text_artifact"),
            patch("src.tawreed.matching.tawreed_match_logs.append_text_artifact"),
            patch("src.tawreed.matching.tawreed_match_logs.append_csv_artifact") as append_csv,
        ):
