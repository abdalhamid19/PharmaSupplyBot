...
BASELINE_VIOLATIONS = {
    ...
    "src/ui/streamlit_product_matching.py:22:function_lines:render_product_matching_tab:21",
    "src/ui/streamlit_product_matching.py:45:function_lines:product_matching_form:35",
    "src/ui/streamlit_product_matching.py:file_lines:159",
