...
def _legacy_saved_audit_noop(report) -> None:
    """Legacy no-op retained for compatibility with old imports."""
    return
    metadata = ()
    if False:  # Legacy body intentionally disabled; audit is artifact-only.
