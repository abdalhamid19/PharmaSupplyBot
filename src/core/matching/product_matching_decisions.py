"""Decision logic, diagnostics, and candidate builders — consolidated."""
...
# ── Diagnostic record (from product_matching_decisions_diagnostics.py) ──
...
# ── Candidate diagnostic builders (from product_matching_decisions_builders.py) ──
...
# ── Main decision logic (from product_matching_decisions_main.py) ──
