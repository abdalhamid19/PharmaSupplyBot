"""Response parsing and handling for AI verifier API calls.

This module handles API response processing, error handling, and JSON parsing.
"""
...
class ResponseHandler:
    ...
    def __init__(self, planner, failure_tracker):
