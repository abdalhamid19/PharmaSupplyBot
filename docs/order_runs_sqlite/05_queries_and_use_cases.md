...
هذا الاستعلام يقرأ سجلات تاريخية كانت تحفظ ترتيب الخصم. التشغيلات الجديدة
تستخدم `lowest_purchase_price` فقط، لذلك لا تُنشأ مقارنات جديدة بين أوضاع
اختيار مختلفة. تبقى النتائج القديمة للقراءة والتدقيق دون إعادة حسابها.
