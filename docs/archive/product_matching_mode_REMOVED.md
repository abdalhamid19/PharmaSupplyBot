...
> **[مؤرشف]** تم حذف ميزة `match-products` من البرنامج (CLI + GUI + المحرك) في 2026-09-01.
> المحتوى التالي محفوظ للمرجع التاريخي فقط. المطابقة داخل order (`--match-only`) لم تُمس.
