...
- [ ] أضف حالة للموافقة ذات `excel_target_row_key` بفرعين: احفظ الموافقة لصف، ثم بدّل محتواه مع إبقاء `target_key` واسم ملف المصدر ورقم الصف كما هي؛ في الفرع الأول غيّر كود المنتج وحده، وفي الثاني غيّر اسم المنتج وحده. أثبت في الحالتين أن مفتاح الصف الحالي يختلف عن المحفوظ، وأن الموافقة القديمة لا تُطبّق ولا تُجبر معرف المنتج القديم؛ تستمر المطابقة من بيانات الصف الحالية أو تُحال للمراجعة وفق أدلتها. يحاكي ذلك استبدال محتوى الملف مع بقاء اسمه نفسه، ويتحقق من تأثير كل جزء من هوية المنتج.
